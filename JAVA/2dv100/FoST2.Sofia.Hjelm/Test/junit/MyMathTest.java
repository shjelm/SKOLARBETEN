...
public class MyMathTest {
	...
	public void testMultiply() {
	   ...
	   assertEquals("10 x 5 must be 50", 50, MyMath.mult(10, 5));  // check 10*5 = 50
	   assertEquals("-7 x 5 must be -35", -35, MyMath.mult(-7, 5));  // check -7*5 = -35
	   
	   /* Test a case with large numbers, check 23246*7958 = 184991668 */
	   assertEquals("23246 x 7958 must be 184991668", 184991668, MyMath.mult(23246, 7958)); 
	   
	   /* Force exception */
	   int n = MyMath.mult(10, -1);
	 } 
