...
public class TreeWordSet implements WordSet {
	...
	public String toString(BST root) {
        ...
        if (root != null) {
                s.append(toString(root.right));	// append left sub-tree
                s.append(root.value + ", ");	        // append 
                s.append(toString(root.left));	// append right sub-tree
        }
        return s.toString();
	}
